...
public class DefaultSummaryUseCase: SummaryUseCase {
    ...
    public var summariesStream: RxSwift.BehaviorSubject<[Entity.SummaryDetail]> = .init(value: [])
    
    public func fetchAllSummaries() -> RxSwift.Single<Result<Void, Entity.SummariesError>> {
        <#code#>
    }
